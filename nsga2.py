...
class Individual(list):
    '''
    Individual is an allele or chromosome type.
    Extending its class to list using polymorphism, such it internal memory
    for storing its own values in. This is superseeded by DEAP stats and pop however
    '''
...
def brute_force_optimize(ff):
    '''
    This is for comparing performance of GA later.
    '''
...
if __name__ == "__main__":
    ...
    print(stats)
    brute_force_optimize(ff)
    print('pareto front top3 values')
    print(pop[0].stored_value,pop[1].stored_value,pop[2].stored_value)
    #print(pop)
